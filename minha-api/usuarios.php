<?php
    ...
    if($metodo === "GET"){
        ...
        if(isset($_GET["id"])){
            ...
            */
            ...
            //echo json_encode($usuario);//Mesma coisa que a linha debaixo
            responder($usuario);
        }else{
            /*
            //Sem controller
        ...
        usuarios.php
            ...
            └── UsuarioController
                    ...
                    └── listar()
            */
            $usuarios = $controller->listar();//"Controller, execute o método listar e passe para ele a conexão $pdo."
            responder($usuarios);
        }
    }else if($metodo === "POST"){
    /*    
    ...
    */
    //CADASTRAR
        $dados = json_decode(//Transforma o JSON que veio pelo input do Body do POSTMAN e tranforma em um array PHP
            file_get_contents("php://input"), //para pegar o conteúdo, que vem no BODY do POSTMAN, por exemplo
            true
        );
